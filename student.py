...
class Student:
    def __init__(self, root):
        ...
        # first image
        img = Image.open(r"C:\Users\N J JNR\Documents\Python\Flask Apps\face_recognition\collage_img\download.jpg")
        ...
        # second image
        img1 = Image.open(r"C:\Users\N J JNR\Documents\Python\Flask Apps\face_recognition\collage_img\download.jpg")
        ...
        # third image
        img2 = Image.open(r"C:\Users\N J JNR\Documents\Python\Flask Apps\face_recognition\collage_img\download.jpg")
        ...
        # background image
        img3 = Image.open(r"C:\Users\N J JNR\Documents\Python\Flask Apps\face_recognition\collage_img\bg1.jpg")
        ...
        img_left = Image.open(r"C:\Users\N J JNR\Documents\Python\Flask Apps\face_recognition\collage_img\gctu2.jpg")
        ...
        dep_combo["values"] = ("Select Department", "Computer Science", "Engineering", "IT", "Telecom Engineering")
        dep_combo.current(0)
        ...
        course_combo["values"] = ("Select Course", "Computer Science", "Engineering", "IT", "Telecom Engineering")
        ...
        year_combo["values"] = ("Select Year", "2021-2021", "2022-2024",  "2025-2026")
        ...
        #Lecturer
        lecturer_label=Label(class_student_frame,text="Lecturer:",font=("times new roman",12,"bold"),bg="white")
        lecturer_label.grid(row=4,column=2,padx=0,pady=5,sticky=W)

        lecturer_entry=ttk.Entry(class_student_frame,width=20,font=("times new roman",12,"bold"))
        lecturer_entry.grid(row=4,column=3,padx=0,pady=5,sticky=W)

        
        #radio button
        radionbtn1=ttk.Radiobutton(class_student_frame,text="Take a photo sample",value="Yes")
        ...
        img_right = Image.open(r"C:\Users\N J JNR\Documents\Python\Flask Apps\face_recognition\collage_img\gctu2.jpg")
        ...
        self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","sem","id","name","div","roll","dob","email","lecturer","phone","address","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
